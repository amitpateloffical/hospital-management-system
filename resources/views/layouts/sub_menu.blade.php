...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('live-consultation*','live-meeting*', 'connect-google-calendar*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (Request::is('currency-settings*','settings*','payment-gateway*','hospital-schedules','custom-fields*')) ? '' : 'd-none' }}">
